...
- **System Logs**: Contain information about system-level operations, such as driver failures and shutdown events.
- **Security Logs**: Record authentication attempts, access control modifications, and security-related events.
- **Application Logs**: Store application-specific messages, errors, and warnings generated by software.
- **Setup Logs**: Capture system installation and upgrade activities.
- **Forwarded Logs**: Contain logs collected from remote devices via event forwarding.
